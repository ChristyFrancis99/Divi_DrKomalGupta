...
const About = () => {
  ...
  return (
    <Layout>
        ...
        <div className="container-custom relative">
          <div className="max-w-3xl animate-fade-up opacity-0">
            ...
            <p className="text-xl text-primary-foreground/75 leading-relaxed">
              Our Proffesionals has been providing exceptional healthcare
              services to our community for over 8 years, combining cutting-edge
      ...
      <section
        ref={statsRef}
        className="py-14 bg-white border-b border-olive-100/60 relative -mt-1"
      >
